  ...
  static get styles() {
    return [
      ...
      css`
        ...
        .auth-card {
          background: linear-gradient(155deg, var(--ddd-theme-card, #243044), var(--ddd-theme-card-deep, #1a2332));
          border: 1px solid var(--ddd-theme-card-border, rgba(240, 192, 64, 0.18));
          border-radius: 12px;
        ...
        .auth-card::before {
          ...
          height: 2px;
          background: linear-gradient(90deg, transparent, var(--ddd-theme-primary, #f0c040), transparent);
          opacity: 0.7;
        }
        h2 {
          color: var(--ddd-theme-default-text, #f5f2eb);
          font-family: var(--ddd-font-display, 'Instrument Serif', Georgia, serif);
        ...
        h2 .auth-icon {
          ...
          margin-right: 8px;
          color: var(--ddd-theme-primary, #f0c040);
          font-size: 1.25em;
          vertical-align: -0.12em;
        }
        .subtitle {
          color: var(--ddd-theme-secondary, rgba(255,255,255,0.65));
        ...
        .field input {
          width: 100%;
          padding: 12px 14px;
          border: 1px solid var(--ddd-theme-input-border, rgba(255,255,255,0.12));
          border-radius: 6px;
          font-size: 15px;
          font-family: var(--ddd-font-primary, 'DM Sans', system-ui, sans-serif);
        ...
        .field input:focus {
          outline: none;
          border-color: var(--ddd-theme-primary, #f0c040);
        ...
        .btn {
          ...
          background: linear-gradient(120deg, var(--ddd-theme-primary, #f0c040), var(--ddd-theme-accent, #f0c040));
          color: var(--ddd-theme-on-primary, #1a2332);
        ...
        .user-email {
          font-size: var(--ddd-font-size-4xs, 13px);
          color: var(--ddd-theme-secondary, rgba(255,255,255,0.6));
          overflow: hidden;
          text-overflow: ellipsis;
          white-space: nowrap;
        }
        .user-meta {
          ...
          color: var(--ddd-theme-secondary, rgba(255,255,255,0.5));
          margin-top: 4px;
          overflow: hidden;
          text-overflow: ellipsis;
          white-space: nowrap;
        ...
        .loading::before {
          ...
          border-top-color: var(--ddd-theme-primary, #f0c040);
          border-radius: 50%;
          vertical-align: -2px;
